...
|:--------------------|:-------------------:|:------------:|
|Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.|Tareas| Conclusion de Student Outcome|
|Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software.|Tareas|Conclusion de Student Outcome|
<br><br>
